...
enum CLICommand: Equatable {
    ...
    func makeEventEnvelope(requestID: String = UUID().uuidString) -> AutomationEventEnvelope {
        switch self {
        case .agentPrepareManagedLaunch, .agentManagedLaunchPreflightDecision, .appControlList, .appControlRun, .sessionScopeShow, .sessionScopeSetCurrent, .sessionScopeSet, .sessionScopeAdd, .sessionScopeClear:
