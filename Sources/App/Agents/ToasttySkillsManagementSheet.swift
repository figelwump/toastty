    ...
    private var header: some View {
        HStack(alignment: .top, spacing: 16) {
            VStack(alignment: .leading, spacing: 5) {
                ...
                Text("Toastty provides its six built-in skills, plus your user-created skills, to managed Codex, Claude Code, Cursor, Pi, OpenCode, and MiMo Code sessions. Ordinary sessions are unaffected.")
                    .font(.system(size: 12))
