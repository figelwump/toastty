...
enum ToastyTheme {
    ...
    static let hiddenSessionPillText = Color(hex: 0xD9D4CE)
    static let workspaceAgentCountActiveBackground = Color(hex: 0xF5A623, alpha: 0.15)
    static let workspaceUnreadPillBackground = Color(hex: 0x5BA08A, alpha: 0.14)
    ...
    static let sidebarDisclosureBackground = Color(hex: 0x34302B)
    ...
    static let sessionWaitingChipRing = Color(hex: 0xC1AA8A, alpha: 0.42)
    static let sessionResumingDetailText = Color(hex: 0xCFA070)
    ...
    static func sessionStatusOutlineColor(for kind: SessionStatusKind) -> Color {
        switch kind {
        case .idle, .working, .needsApproval, .ready, .error:
