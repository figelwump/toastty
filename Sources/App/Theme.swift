...
enum ToastyTheme {
    ...
    static let fontWorkspaceSubtitle = Font.system(size: 11, weight: .regular, design: .monospaced)
    ...
    static let fontWorkspaceSessionPath = Font.system(size: 11, weight: .regular, design: .monospaced)
