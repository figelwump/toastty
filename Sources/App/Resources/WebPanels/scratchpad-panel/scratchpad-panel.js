(()=>{var J="toasttyScratchpadPanel";function h(e){window.webkit?.messageHandlers?.[J]?.postMessage(e)}var r={bridgeReady(){h({type:"bridgeReady"})},consoleMessage(e,t,n="panel"){h({type:"consoleMessage",level:e,message:t,diagnosticSource:n})},javascriptError(e,t,n,a,s,p="panel"){h({type:"javascriptError",message:e,source:t,line:n,column:a,stack:s,diagnosticSource:p})},unhandledRejection(e,t,n="panel"){h({type:"unhandledRejection",reason:e,stack:t,diagnosticSource:n})},cspViolation(e,t,n,a,s,p,l,o="panel"){h({type:"cspViolation",violatedDirective:e,effectiveDirective:t,blockedURI:n,sourceFile:a,line:s,column:p,disposition:l,diagnosticSource:o})},renderReady(e,t){h({type:"renderReady",displayName:e,revision:t})}};var q=["default-src 'none'","script-src 'unsafe-inline'","script-src-elem 'unsafe-inline'","script-src-attr 'none'","style-src 'unsafe-inline'","img-src data: blob:","font-src https: data: blob:","media-src data: blob:","connect-src 'none'","frame-src 'none'","worker-src 'none'","object-src 'none'","base-uri 'none'","form-action 'none'"].join("; "),D="toastty:scratchpad-generated-diagnostic:v1";function z(){return`<meta http-equiv="Content-Security-Policy" content="${q.replaceAll('"',"&quot;")}">`}function K(e){return`<script>
(() => {
