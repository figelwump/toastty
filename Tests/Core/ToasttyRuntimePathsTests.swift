...
struct ToasttyRuntimePathsTests {
    ...
    func resolveDefaultsToHomeBackedLocations() {
        ...
        #expect(paths.recentRightPanelItemsFileURL.path == "/tmp/toastty-home/.toastty/recent-right-panel-items.json")
        ...
        #expect(paths.managedAgentHelperInstancesDirectoryURL.path == "/tmp/toastty-home/.toastty/run/managed-agent-helpers")
    ...
    func resolveRuntimeHomeUsesSandboxedLocationsAndStableSuite() throws {
        ...
        #expect(first.recentRightPanelItemsFileURL.path == "\(runtimeHomePath)/recent-right-panel-items.json")
        ...
        #expect(first.managedAgentHelperInstancesDirectoryURL.path == "\(runtimeHomePath)/run/managed-agent-helpers")
