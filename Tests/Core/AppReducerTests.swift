...
struct AppReducerTests {
    ...
    func moveWorkspaceReordersWorkspacesAndKeepsSelectedWorkspaceID() throws {
        ...
        #expect(reducer.send(.createWorkspace(windowID: windowID, title: "Two"), state: &state))
        #expect(reducer.send(.createWorkspace(windowID: windowID, title: "Three"), state: &state))
