...
struct WorkspaceSplitTreeTests {
    ...
    @Test
    func renderedLayoutZoomsFocusedSlotWhenFocusedPanelModeIsActive() throws {
        ...
        #expect(renderedLayout.identity == WorkspaceRenderIdentity(workspaceID: workspaceID, zoomedSlotID: rightSlotID))
        ...
        #expect(projection.slots.map(\.slotID) == [rightSlotID])
        #expect(projection.dividers.isEmpty)
    }
    ...
    func renderedLayoutUsesFullTreeWhenFocusedPanelModeIsDisabled() {
        ...
        #expect(renderedLayout.identity == WorkspaceRenderIdentity(workspaceID: workspaceID, zoomedSlotID: nil))
    ...
    func splittingPlacesNewLeafOnRequestedSide() throws {
        ...
        for expectation in expectations {
            ...
            guard case .split(_, let orientation, _, let first, let second) = splitTree.root,
