...
- `~/.toastty/config`
  - Toastty-specific preferences such as persisted terminal font overrides.
...
- The `shortcut-trace.sh` automation script requires Accessibility and Automation permissions because it drives real keyboard shortcuts through `osascript`.
