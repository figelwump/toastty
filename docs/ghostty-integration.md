...
- When a terminal is focused, `View > Increase Text Size`, `Decrease Text Size`, and `Reset Text Size` adjust the window-local terminal font override without rewriting `~/.toastty/config`
