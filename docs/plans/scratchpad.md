...
This document is exploratory and predates the current web-panel spec. Follow `docs/plans/web-panels.md` for the current shared panel/runtime direction, then revisit scratchpad-specific behavior on top of that substrate.
