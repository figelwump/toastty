...
This document is exploratory and predates the current web-panel spec. Follow `docs/plans/web-panels.md` for current panel architecture decisions. Keep this document for older ideas that may still inform later CLI/feed/extension work.
